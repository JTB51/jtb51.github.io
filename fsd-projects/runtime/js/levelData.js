    ...
    var levelData = [
      {
        ...
        speed: -3,
        gameItems: [
          { type: "scuffle", x: 400, y: groundY + 10, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -75, scale: 0.2},
          { type: "scuffle", x: 600, y: groundY - 115, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -65, scale: 0.2},
          { type: "scuffle", x: 800, y: groundY - 115, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -65, scale: 0.2},
          { type: "scuffle", x: 1000, y: groundY + 10, damage: 18, image: "img/marioenemy.png", offsetX: -70, offsetY: -90, scale: 0.2},
          { type: "scuffle", x: 1200, y: groundY + 10, damage: 18, image: "img/marioenemy.png", offsetX: -70, offsetY: -90, scale: 0.2},
          { type: "scuffle", x: 1400, y: groundY - 115, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -65, scale: 0.2},
          { type: "scuffle", x: 1600, y: groundY + 10, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -75, scale: 0.2},
          { type: "scuffle", x: 1800, y: groundY - 115, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -65, scale: 0.2},
          { type: "scuffle", x: 2000, y: groundY + 10, damage: 18, image: "img/marioenemy.png", offsetX: -70, offsetY: -90, scale: 0.2},
          { type: "scuffle", x: 2200, y: groundY - 115, damage: 18, image: "img/scuffle.png", offsetX: -50, offsetY: -65, scale: 0.2},
